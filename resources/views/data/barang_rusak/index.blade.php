<x-app-layout>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="p-6 bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                ...
                <div class="flex justify-between mb-4">
                    <h3 class="text-lg font-medium dark:text-gray-100">Daftar Barang Rusak</h3>

                    <button onclick="document.getElementById('modalTambahRusak').style.display='flex'"
                ...
                <div class="w-full overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                        ...
                        <tbody class="bg-gray-100 divide-y dark:bg-gray-800 dark:divide-gray-700">
                            ...
                            @forelse ($barangRusaks as $rusak)
                                <tr>
                                    <td class="px-4 py-2">{{ $rusak->barang->nama_barang }}</td>
                                    <td class="px-4 py-2">{{ $rusak->jumlah_kardus }}</td>
                                    <td class="px-4 py-2">{{ $rusak->jumlah_ecer }}</td>
                                    <td class="px-4 py-2">{{ $rusak->keterangan }}</td>
                                ...
                                {{-- Modal Edit --}}
                                <div id="modalEditRusak-{{ $rusak->id_barang_rusak }}"
                                        ...
                                        <form action="{{ route('barangRusak.update', $rusak->id_barang_rusak) }}"
                                            ...
                                            <div class="grid grid-cols-1 gap-3">
                                                ...
                                                <select name="id_barang" required
                                                    ...
                                                    @foreach ($barangs as $barang)
                                                        <option value="{{ $barang->id_barang }}"
                                                            @selected($barang->id_barang == $rusak->id_barang)>
                                                            {{ $barang->nama_barang }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <input type="number" name="jumlah_kardus"
                                                    value="{{ $rusak->jumlah_kardus }}" required min="0"
                                                    class="px-3 py-2 border rounded dark:bg-gray-700">

                                                <input type="number" name="jumlah_ecer"
                                                    value="{{ $rusak->jumlah_ecer }}" required min="0"
                                                    class="px-3 py-2 border rounded dark:bg-gray-700">

                                                <textarea name="keterangan" class="px-3 py-2 border rounded dark:bg-gray-700">{{ $rusak->keterangan }}</textarea>

                                                <input type="date" name="tanggal_rusak"
                                                    value="{{ $rusak->tanggal_rusak }}" required
                                                    class="px-3 py-2 border rounded dark:bg-gray-700">
                                            ...
                                            <div class="flex justify-end gap-3 mt-4">
                                                <button type="button"
                                                    onclick="document.getElementById('modalEditRusak-{{ $rusak->id_barang_rusak }}').style.display='none'"
                                ...
                                {{-- Modal Delete --}}
                                <div id="modalDeleteRusak-{{ $rusak->id_barang_rusak }}"
                                    class="fixed inset-0 z-50 items-center justify-center modal" style="display:none;">
                                    ...
                                    <div class="w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-2xl">
                                        ...
                                        <form action="{{ route('barangRusak.destroy', $rusak->id_barang_rusak) }}"
                                            ...
                                            <div class="flex justify-end gap-3">
                                                ...
                                                <button type="button"
                                                    onclick="document.getElementById('modalDeleteRusak-{{ $rusak->id_barang_rusak }}').style.display='none'"
                                                    class="px-4 py-2 bg-gray-300 rounded">Batal</button>
                    ...
                    <div class="flex justify-center mt-4">
                     {{ $barangRusaks->onEachSide(1)->links('pagination::tailwind') }}
                    </div>
                </div>
    ...
    {{-- Modal Tambah --}}
    <div id="modalTambahRusak" class="fixed inset-0 z-50 items-center justify-center modal" style="display:none;">
        ...
        <div class="w-full max-w-lg p-6 bg-white dark:bg-gray-800 rounded-2xl">
            ...
            <form action="{{ route('barangRusak.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-3">
                    ...
                    <textarea name="keterangan" placeholder="Keterangan (Opsional)" class="px-3 py-2 border rounded dark:bg-gray-700"></textarea>

                    <input type="date" name="tanggal_rusak" required
                        class="px-3 py-2 border rounded dark:bg-gray-700">
                ...
                <div class="flex justify-end gap-3 mt-4">
                    ...
                    <button type="button" onclick="document.getElementById('modalTambahRusak').style.display='none'"
                        class="px-4 py-2 bg-gray-300 rounded">Batal</button>
